        ...
        <div class="container mx-auto px-6 lg:px-16">
            <div class="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
                ...
                <div class="flex justify-center hero-image">
                    <img src="<?php echo base_url('assets/gym_foto/10fe3850984220be97243e714da1f13e-removebg-preview.png'); ?>"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
                    <div class="flex flex-col gap-4">
                        <img src="<?php echo base_url('assets/gym_foto/download (43).jpg'); ?>" alt="Member Workout"
    ...
    <section class="py-20 bg-[#f8f4f1]">
        <div class="container mx-auto px-6 lg:px-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                ...
                <div class="bg-white rounded-2xl shadow-md overflow-hidden card-hover staggered-item">
                    <div class="overflow-hidden">
                        <img src="<?php echo base_url('assets/gym_foto/(1) Instagram_files/491464294_17846180673453354_906816609803980329_n.jpg'); ?>"
                            class="w-full h-56 object-cover hover-scale">
                    </div>
                    <div class="p-6 space-y-3">
                        <span class="text-sm text-gray-500 block">10-10-2025</span>
